...
const faqData: FAQItem[] = [
    ...
    {
        id: 3,
        question: "Задание на проектирование",
        answer: (
            <>
                <p>
    ...
    {
        id: 4,
        question: "Этапы проектирования ЗНП, П, Р",
        answer: (
            <>
                <h3>Задание на проектирование</h3>
                <p>
                    Задание на проектирование можно считать нулевым этапом. Этот документ включает перечень целей, задач, требований и условий заказчика, документально оформленных в письменном виде и выданных исполнителю работ - проектной организации.
                </p>
                <p>
                    Документ содержит основные требования, предъявляемые к объекту, стадии разработки проектной документации, её перечень и сроки выполнения, а также требования, обусловленные спецификой строения и условиями его эксплуатации.
                </p>
                <p>
                    Чётко прописанное техническое задание на проектирование, с указанием всех нюансов и особенностей будущего объекта значительно поможет конструкторам и архитекторам в работе. Данные ТЗ станут для них основой создания проекта объекта и территории, планов этажей и помещений, дизайна интерьера и экстерьера фасада, инженерно-технических и архитектурных решений.
                </p>
                <p>
                    Задание на разработку проектной документации составляется заказчиком проекта. Задание может быть подготовлено подрядчиком (проектировщиком) по поручению заказчика в соответствии с договором подряда на выполнение проектных работ.
                </p>
                <p>
                    После выяснения всех деталей и корректировок, ТЗ утверждается и подписывается заказчиком и проектировщиком. Задание на разработку проектной документации является неотъемлемым приложением договора.
                </p>

                <h3>Проектная документация</h3>
                <p>
                    Проектная документация - это детальное описание будущей сети с обоснованием принятых решений. Основной вопрос, который раскрывается в Проектной документации – что строим. В состав проектной документации входят:
                </p>
                <ul className={styles.faqList}>
                    <li>титульный лист и лист согласования;</li>
                    <li>пояснительная записка с обоснованием выбранных решений;</li>
                    <li>структурная схема;</li>
                    <li>структурная схема системы электроснабжения и заземления;</li>
                    <li>схемы расположения элементов телекоммуникационной инфраструктуры;</li>
                    <li>схемы организации рабочих мест;</li>
                    <li>схемы подключений магистральной и горизонтальной подсистем.</li>
                </ul>

                <h3>Рабочая документация</h3>
                <p>
                    Рабочая документация (РД) это документ, детально раскрывающий все этапы реализации системы. Качественно составленный рабочий проект может обеспечить монтаж даже сторонними подрядчиками. Проектирование ведется с учетом федеральных законов, постановлений правительства, государственных стандартов, сводов правил и отраслевых стандартов.
                </p>
                <p>
                    Состав рабочей документация (проекта):
                </p>
                <ul className={styles.faqList}>
                    <li>титульный лист</li>
                    <li>общие данные</li>
                    <li>условные-графические изображения</li>
                    <li>структурную схему системы</li>
                    <li>планы размещения оборудования, кабельных трасс и элементов проектируемых систем</li>
                    <li>схемы электрических соединений</li>
                    <li>кабельный журнал с указанием длины и типа кабеля</li>
                    <li>спецификация изделий, оборудования и материалов</li>
                    <li>необходимые расчёты</li>
                    <li>расчеты времени работы системы от резервированных источников питания</li>
                    <li>задания для смежных инженерных систем</li>
                </ul>
                <p>
                    Итог этапа рабочего проектирования – создание полного комплекта документации, предоставляющего исчерпывающую информацию для проведения монтажных работ.
                </p>
                <p>
                    Вы получает полную документацию на создание системы. Проект соответствует российским нормам и правилам, европейским и международным стандартам.
                </p>
                <p>
                    Мы приступаем к выполнению работ после подписания Задания на проектирование и договора, выполняя проектирование нескольких систем параллельно.
                </p>
            </>
        )
    },
