...
const reviews: Review[] = [
    {
        id: 1,
        text: "Александр Лабзин показал себя как ответственный, аккуратный и добросовестный специалист. Все работы выполняются качественно и в срок, а иногда даже с опережением. Отлично владеет нормативной базой, своевременно вносит аргументированные правки, адекватно реагирует на замечания.",
        author: "В.Ю. Гусев",
        company: "ООО «КОВЧЕГ»"
    },
    {
        id: 2,
        text: "Коллектив ИТЦ «Колибри» выражает благодарность за сотрудничество с 2016 года. Благодаря вашей проектной документации обеспечена противопожарная безопасность на объектах наших клиентов. Ценим ваш профессионализм и поддержку в сложных ситуациях. Надеемся на дальнейшее плодотворное сотрудничество.",
        author: "И.А. Самокрутов",
        company: "ИТЦ «Колибри»"
    },
    {
        id: 3,
